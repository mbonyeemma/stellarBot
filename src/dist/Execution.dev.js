...
function () {
  ...
  _createClass(Execution, [{
    ...
    value: function placeSellOrder(assetToSell, amount, price) {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 19:
              ...
              return _context8.abrupt("return", transactionResult.hash);
      ...
      }, null, this, [[2, 30], [16, 23]]);
    }
  }, {
    key: "StrictSendTransaction",
    value: function StrictSendTransaction(assetToSell, amount) {
      var senderKeypair, sellingAsset, data, _ref7, _ref8, fee, sender, manageSellOfferOp, transaction, transactionResult;

      return regeneratorRuntime.async(function StrictSendTransaction$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              data = {
                ...
                destAsset: _stellarSdk.Asset["native"](),
                destMin: "0.0000001"
              };
              console.log("sellArray", data);
              _context9.next = 8;
            ...
            case 8:
              ...
              fee = _ref8[0].max_fee.mode;
              sender = _ref8[1];
              manageSellOfferOp = _stellarSdk["default"].Operation.pathPaymentStrictSend(data);
              transaction = new _stellarSdk["default"].TransactionBuilder(sender, {
                fee: fee,
                networkPassphrase: _stellarSdk["default"].Networks.PUBLIC
              }).addOperation(manageSellOfferOp).setTimeout(100).build();
            ...
            case 18:
              transactionResult = _context9.sent;
              return _context9.abrupt("return", transactionResult.hash);

            case 22:
              _context9.prev = 22;
              _context9.t0 = _context9["catch"](15);
              console.error("Oh no! Something went wrong.");
              console.error("Operations:", _context9.t0.response.data.extras.result_codes.operations);
            ...
            case 29:
              ...
              console.error("Error managing sell offer:", _context9.t1);
              return _context9.abrupt("return", false);
    ...
    value: function getAssetPrice(assetToBuy) {
      ...
      return regeneratorRuntime.async(function getAssetPrice$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 7:
              ...
              return _context10.abrupt("return", price);

            case 11:
              _context10.prev = 11;
              _context10.t0 = _context10["catch"](0);
              console.error('Error fetching asset price:', _context10.t0);
    ...
    value: function getAssetBalance(asset) {
      ...
      return regeneratorRuntime.async(function getAssetBalance$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 12:
              return _context11.abrupt("return", balance);

            case 15:
              _context11.prev = 15;
              _context11.t0 = _context11["catch"](0);
              console.error('Error fetching asset balance:', _context11.t0);
